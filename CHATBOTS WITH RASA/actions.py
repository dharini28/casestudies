...
class ActionSearchRestaurants(Action):
    ...
    config = {"user_key": "361f4288e9891bc68767f112d9d6be6d"}
...
class VerifyLocation(Action):
    ...
    def __init__(self):
        ...
        self.TIER_2 = ['agra', 'ajmer', 'aligarh','amravati','amritsar','asansol','aurangabad', 'bareilly', 'belgaum', 'bhavnagar', 'bhiwandi','bhubaneswar', 'bikaner', 'bokaro steel city', 'chandigarh', 'coimbatore', 'cuttack', 'dehradun', 'dhanbad', 'bhilai', 'durgapur', 'erode', 'faridabad', 'firozabad', 'ghaziabad', 'gorakhpur', 'gulbarga', 'guntur', 'gurgaon', 'guwahati','hamirpur', 'hubli-dharwad', 'indore', 'jabalpur', 'jaipur', 'jalandhar', 'jammu', 'jamnagar', 'jamshedpur', 'jhansi', 'jodhpur', 'kannur', 'kanpur', 'kakinada', 'kochi','kolhapur','kollam','kozhikode', 'kurnool', 'lucknow','madurai', 'malappuram', 'mathura', 'goa', 'mangalore', 'meerut', 'moradabad', 'mysore', 'nagpur', 'nanded', 'nashik', 'nellore', 'noida', 'patna', 'pondicherry','purulia','parayagraj', 'raipur', 'rajkot', 'rajahmundry', 'ranchi', 'rourkela', 'salem', 'sangli', 'siliguri', 'solapur', 'srinagar', 'surat', 'thiruvananthapuram', 'thrissur', 'tiruchirappalli','tiruppur', 'ujjain','bijapur',  'vadodara', 'varanasi', 'vasai-virar city', 'vijayawada', 'visakhapatnam', 'warangal','vellore']
    def name(self):
...
class ActionSendEmail(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        s.starttls()
        s.login("upgradchatbot123@gmail.com", "Infy@123")
        ...
        msg['From'] = "upgradchatbot123@gmail.com"
...
def retrieve_restaurant(lat, lon, cuisines_dict, cuisine, res_key, d_rest):
    ...
    headers = {'Accept': 'application/json',
                'user-key': '361f4288e9891bc68767f112d9d6be6d'}
    try:
